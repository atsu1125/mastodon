    ...
    return (
      <ColumnsAreaContainer ref={this.setRef} singleColumn={mobile}>
        <WrappedSwitch>
          ...
          <WrappedRoute path={['/public/domain/:domain', '/timelines/public/domain/:domain']} component={DomainTimeline} content={children} />
          ...
          <WrappedRoute path='/visits' component={Visits} content={children} componentParams={{ shouldUpdateScroll: this.shouldUpdateScroll }} />
