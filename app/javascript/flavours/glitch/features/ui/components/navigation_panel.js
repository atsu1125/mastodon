...
import { profile_directory, disablePublicTimelines, disableLocalTimeline, isStaff, showTrends } from 'flavours/glitch/util/initial_state';
...
const NavigationPanel = ({ onOpenSettings }) => (
  <div className='navigation-panel'>
    ...
    {(!disableLocalTimeline || isStaff) && <NavLink className='column-link column-link--transparent' to='/public/local' data-preview-title-id='column.community' data-preview-icon='users' ><Icon className='column-link__icon' id='users' fixedWidth /><FormattedMessage id='tabs_bar.local_timeline' defaultMessage='Local' /></NavLink>}
    {(!disablePublicTimelines || isStaff) && <NavLink className='column-link column-link--transparent' exact to='/public' data-preview-title-id='column.public' data-preview-icon='globe' ><Icon className='column-link__icon' id='globe' fixedWidth /><FormattedMessage id='tabs_bar.federated_timeline' defaultMessage='Federated' /></NavLink>}
